...
<head>
    ...
    <title>{{ \App\Models\Settings::where('key', 'system_title')->value('value') ?? 'CCS - Inventory System' }}</title>
    ...
    <header class="fixed top-0 left-0 right-0 bg-white shadow-sm z-50 border-b-2 border-[#ffcc34]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <img src="{{ asset('images/CCS.jpg') }}" alt="CCS Logo" class="h-8" onerror="this.src='/images/CCS.jpg'">
                <h1 class="text-base font-semibold text-gray-900">
                    {{ \App\Models\Settings::where('key', 'system_title')->value('value') ?? 'CCS - Inventory System' }}
                </h1>
            </div>
